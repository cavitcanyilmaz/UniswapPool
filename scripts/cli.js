...
const contractABI = require("../artifacts/contracts/Uniswappool.sol/Uniswappool.json").abi;

program
    .name("uniswappool-cli")
    .description("CLI tool for Uniswappool smart contract")
    .version("1.0.0");
